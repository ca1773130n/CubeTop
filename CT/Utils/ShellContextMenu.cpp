...
UINT CShellContextMenu::ShowContextMenu(CWnd *pWnd, CPoint pt)
{
	...
	pContextMenu->QueryContextMenu (m_Menu->m_hMenu, m_Menu->GetMenuItemCount (), MIN_ID, MAX_ID, CMF_NORMAL | CMF_CANRENAME | CMF_EXPLORE);
	...
	if (idCommand == 19 ) return idCommand;
